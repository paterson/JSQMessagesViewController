...
- (void)jsq_configureMessagesViewController
{
    ...
    self.outgoingEventCellIdentifier = [JSQMessagesEventCollectionViewCellOutgoing cellReuseIdentifier];
    self.incomingEventCellIdentifier = [JSQMessagesEventCollectionViewCellIncoming cellReuseIdentifier];
