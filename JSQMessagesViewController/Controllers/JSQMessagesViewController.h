 ...
 * incomingCellIdentifier and outgoingCellIdentifier for events
 
 */

@property (copy, nonatomic) NSString *incomingEventCellIdentifier;
@property (copy, nonatomic) NSString *outgoingEventCellIdentifier;
