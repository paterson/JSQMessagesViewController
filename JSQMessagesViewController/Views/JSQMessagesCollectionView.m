...
- (void)jsq_configureCollectionView
{
    ...
    [self registerNib:[JSQMessagesEventCollectionViewCellIncoming nib]
          forCellWithReuseIdentifier:[JSQMessagesEventCollectionViewCellIncoming cellReuseIdentifier]];
    
    [self registerNib:[JSQMessagesEventCollectionViewCellOutgoing nib]
          forCellWithReuseIdentifier:[JSQMessagesEventCollectionViewCellOutgoing cellReuseIdentifier]];
