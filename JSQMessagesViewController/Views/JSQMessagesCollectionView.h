...
/**
 * Custom methods for handling events
 */

- (bool)collectionView:(JSQMessagesCollectionView *)collectionView shouldShowEventForItemAtIndexPath:(NSIndexPath *)indexPath;

- (NSString *)collectionView:(JSQMessagesCollectionView *)collectionView titleForEventAtIndexPath:(NSIndexPath *)indexPath;

- (NSString *)collectionView:(JSQMessagesCollectionView *)collectionView timeForEventAtIndexPath:(NSIndexPath *)indexPath;
